            ...
            if (btnAddUpdate.Text == "Add")
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        int data = staffTA.insertStaff(staff.SID, staff.StaffNO, staff.StaffName, staff.StaffDob, staff.StaffJoin, staff.StaffType, staff.Nrc, staff.StaffGender, staff.StaffPhone1, staff.StaffPhone2, staff.StaffAddress,staff.ImagePath,staff.IsDelete);
                        if (data > 0)
                        {
